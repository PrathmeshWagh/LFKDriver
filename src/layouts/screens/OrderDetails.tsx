...
export default function OrderDetails({ navigation, route }: any) {
    ...
    // console.log('oderDetails?.avatar_original ?', oderDetails?.avatar_original);
                    ...
                    <>
                        ...
                        <ScrollView>
                            <View style={styles.custDetailView}>
                                <View>
                                    <Text style={{ fontSize: width * 0.04, fontWeight: '500', marginBottom: 5, color: 'black' }}>
                                ...
                                <View style={styles.custDetail}>
                                    <View style={{ width: '15%' }}>
                                        {
                                            oderDetails?.avatar_original ?
                                                <Image
                                                    source={{ uri: oderDetails?.avatar_original }} style={styles.profileImage} /> :
                                                <View style={{width:40, height:40, borderRadius:20, backgroundColor:"#515151", alignItems:'center', justifyContent:'center' }}>
                                                    <IonIcon name="person-outline" size={25} color="white" />
                                                </View>
                                        }
                            ...
                            <View style={styles.orderView}>
                                ...
                                <View style={{ display: 'flex', justifyContent: 'space-between', alignContent: 'center', marginBottom: 25 }}>
                                    ...
                                    {oderDetails?.coin_product_order_detail.map((product, index) => (
                                        <View key={index} style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignContent: 'center', marginBottom: 25 }}>
                                            <Image
                                                source={{ uri: product.product_img }}
                                                style={styles.productImage}
                                            ...
                                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', }}>
                                                <Image source={require('../../Images/dollar.png')} style={{ width: 30, height: 30, }} />
                                                <Text style={{ fontSize: width * 0.04, color: 'black', marginLeft: 5 }}>{product.gross_loyalty_coins}</Text>
                                            </View>
                                        </View>
                                    ))}
                                </View>
